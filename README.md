## Features
- Using a bottle on an enchanting table does not open the GUI
- Using attack, right click, shift left click, and shift right click abilities will create a client-side visual cooldown
